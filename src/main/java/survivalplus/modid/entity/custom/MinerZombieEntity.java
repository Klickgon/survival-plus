...
public class MinerZombieEntity
    ...
    private static final TrackedData<Boolean> BABY = DataTracker.registerData(MinerZombieEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    /**
    ...
    public void convertTo(EntityType<? extends ZombieEntity> entityType) {
        MinerZombieEntity zombieEntity = (MinerZombieEntity) this.convertTo(entityType, true);
    ...
    class DestroyEggGoal
        ...
        public void tickStepping(WorldAccess world, BlockPos pos) {
            world.playSound(null, pos, SoundEvents.ENTITY_ZOMBIE_DESTROY_EGG, SoundCategory.HOSTILE, 0.5f, 0.9f + MinerZombieEntity.this.random.nextFloat() * 0.2f);
        }
