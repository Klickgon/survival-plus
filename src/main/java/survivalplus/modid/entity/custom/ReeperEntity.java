...
public class ReeperEntity
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new ReeperDestroyBedGoal(Blocks.WHITE_BED, (ReeperEntity)this, 1.0));
        this.goalSelector.add(2, new ReeperDestroyBedGoal(Blocks.BLACK_BED, (ReeperEntity)this, 1.0));
        this.goalSelector.add(2, new ReeperDestroyBedGoal(Blocks.BROWN_BED, (ReeperEntity)this, 1.0));
        this.goalSelector.add(2, new ReeperDestroyBedGoal(Blocks.BLUE_BED, (ReeperEntity)this, 1.0));
        this.goalSelector.add(2, new ReeperDestroyBedGoal(Blocks.CYAN_BED, (ReeperEntity)this, 1.0));
        this.goalSelector.add(2, new ReeperDestroyBedGoal(Blocks.GRAY_BED, (ReeperEntity)this, 1.0));
        this.goalSelector.add(2, new ReeperDestroyBedGoal(Blocks.GREEN_BED, (ReeperEntity)this, 1.0));
        this.goalSelector.add(2, new ReeperDestroyBedGoal(Blocks.LIME_BED, (ReeperEntity)this, 1.0));
        this.goalSelector.add(2, new ReeperDestroyBedGoal(Blocks.MAGENTA_BED, (ReeperEntity)this, 1.0));
        this.goalSelector.add(2, new ReeperDestroyBedGoal(Blocks.ORANGE_BED, (ReeperEntity)this, 1.0));
        this.goalSelector.add(2, new ReeperDestroyBedGoal(Blocks.PINK_BED, (ReeperEntity)this, 1.0));
        this.goalSelector.add(2, new ReeperDestroyBedGoal(Blocks.PURPLE_BED, (ReeperEntity)this, 1.0));
        this.goalSelector.add(2, new ReeperDestroyBedGoal(Blocks.RED_BED, (ReeperEntity)this, 1.0));
        this.goalSelector.add(2, new ReeperDestroyBedGoal(Blocks.YELLOW_BED, (ReeperEntity)this, 1.0));
        this.goalSelector.add(2, new ReeperDestroyBedGoal(Blocks.LIGHT_BLUE_BED, (ReeperEntity)this, 1.0));
        this.goalSelector.add(2, new ReeperDestroyBedGoal(Blocks.LIGHT_GRAY_BED, (ReeperEntity)this, 1.0));
