...
public class ModGamerules {
    ...
    public static final GameRules.Key<GameRules.BooleanRule> INVENTORY_DROP_W_NO_SPAWN = GameRuleRegistry.register("inventoryDropWithNoSpawn", GameRules.Category.PLAYER, GameRuleFactory.createBooleanRule(false));
